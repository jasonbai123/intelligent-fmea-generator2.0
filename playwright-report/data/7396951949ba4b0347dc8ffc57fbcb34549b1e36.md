      ...
      - generic [ref=e86]:
        - generic [ref=e87]:
          ...
          - generic [ref=e89]:
            ...
            - button "DeepSeek (深度求索) 深度求索的中文优化大模型" [active] [ref=e95] [cursor=pointer]:
        ...
        - generic [ref=e120]:
          - generic [ref=e121]:
            - img [ref=e122]
            - text: 模型名称
          - textbox "使用默认模型" [ref=e125]: deepseek-chat
          - paragraph [ref=e126]: "当前选择: deepseek-chat"
        - generic [ref=e127]:
          - generic [ref=e128]:
            - img [ref=e129]
            - text: API 密钥
          - textbox "输入您的 DeepSeek (深度求索) API 密钥" [ref=e132]
          - paragraph [ref=e133]:
            - text: 💡
            - strong [ref=e134]: 前端直接调用模式（新增）：
          - list [ref=e135]:
            - listitem [ref=e136]: 输入API密钥后，前端将直接调用DeepSeek (深度求索) API
            - listitem [ref=e137]: 不需要后端服务支持
            - listitem [ref=e138]: API密钥存储在浏览器本地，不会发送到服务器
            - listitem [ref=e139]: 如果未输入API密钥，将尝试使用后端代理（需要后端配置）
        - generic [ref=e141]:
          - img [ref=e142]
          - generic [ref=e145]:
            - paragraph [ref=e146]: 支持前端直连
            - paragraph [ref=e147]:
              - strong [ref=e148]: API地址：
              - code [ref=e149]: https://api.deepseek.com
            - paragraph [ref=e150]:
              - strong [ref=e151]: 模型：
              - text: deepseek-chat
            - paragraph [ref=e152]: ✅ 输入API密钥后可直接使用，无需后端配置
        - generic [ref=e153]:
          - button "重置默认" [ref=e154] [cursor=pointer]:
            - img [ref=e155]
            - text: 重置默认
          - button "保存设置" [ref=e158] [cursor=pointer]:
            - img [ref=e159]
            - text: 保存设置
```